...
public class BluetoothReceiver extends BroadcastReceiver {
    ...
    //    String historyStr = "redmi";
    String historyStr = "HUAWEI";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (BluetoothDevice.ACTION_FOUND.equals(action)) {  //发现设备
            ...
            if (btDevice.getName() != null && btDevice.getName().contains(historyStr))//HC-05设备如果有多个，第一个搜到的那个会被尝试。
            {
        ...
        } else if (action.equals("android.bluetooth.device.action.PAIRING_REQUEST")) //再次得到的action，会等于PAIRING_REQUEST
        {
            ...
            if (btDevice.getName() != null &&  btDevice.getName().contains(historyStr)) {
                Log.e("here", "OKOKOK");
                try {
